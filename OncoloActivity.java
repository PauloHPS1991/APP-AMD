...
public class OncoloActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oncolo);

        edtnome = (EditText) findViewById(R.id.edtnome);
        listviewMedicos = (ListView) findViewById(R.id.listviewMedicos);

        lista = new ArrayList<Medico>();
        medicosAdapter = new MedicosAdapter(OncoloActivity.this, lista);
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(OncoloActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
        Toast.makeText(OncoloActivity.this,"Medico Selecionado" ,Toast.LENGTH_SHORT).show();
