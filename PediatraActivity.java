...
public class PediatraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(PediatraActivity.this, lista);
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()) {
            Toast.makeText(PediatraActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        } else {
            Toast.makeText(PediatraActivity.this, "Medico Selecionado", Toast.LENGTH_SHORT).show();
    ...
    private void listaMedicos(){
        String url  = HOST + "/readPediatra.php";
