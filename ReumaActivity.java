...
public class ReumaActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reuma);

        edtnome = (EditText) findViewById(R.id.edtnome);
        listviewMedicos = (ListView) findViewById(R.id.listviewMedicos);

        lista = new ArrayList<Medico>();
        medicosAdapter = new MedicosAdapter(ReumaActivity.this, lista);
    ...
    private void listaMedicos(){
        String url  = HOSTT + "/readReuma.php";
        String urll  = HOST + "/readReuma.php";
    ...
    public void seleciona(View view) {
        ...
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(ReumaActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
            Toast.makeText(ReumaActivity.this, "Medico Selecionado", Toast.LENGTH_SHORT).show();
