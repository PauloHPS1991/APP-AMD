...
public class CardioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(CardioActivity.this, lista);
    ...
    private void listaMedicos(){
        String url  = HOST + "/readCardio.php";
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(CardioActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();
