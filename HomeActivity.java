...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(HomeActivity.this, lista);
    ...
    private void listaMedicos(){
        String url  = HOST + "/readHomeopatia.php";
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(HomeActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();
