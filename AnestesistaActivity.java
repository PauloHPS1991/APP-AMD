...
public class AnestesistaActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anestesista);
        edtnome = (EditText) findViewById(R.id.edtnome);
        listviewMedicos = (ListView) findViewById(R.id.listviewMedicos);

        lista = new ArrayList<Medico>();
        medicosAdapter = new MedicosAdapter(AnestesistaActivity.this, lista);
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(AnestesistaActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();
    ...
    private void listaMedicos(){
        String url  = HOST + "/readAnestesista.php";
