...
public class DermatoActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dermato);

        edtnome = (EditText) findViewById(R.id.edtnome);
        listviewMedicos = (ListView) findViewById(R.id.listviewMedicos);

        lista = new ArrayList<Medico>();
        medicosAdapter = new MedicosAdapter(DermatoActivity.this, lista);
    ...
    private void listaMedicos(){
        String url  = HOST + "/readDermato.php";
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(DermatoActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
        Toast.makeText(DermatoActivity.this,"Medico Selecionado" ,Toast.LENGTH_SHORT).show();
