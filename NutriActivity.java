...
public class NutriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(NutriActivity.this, lista);
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(NutriActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
        Toast.makeText(NutriActivity.this,"Medico Selecionado" ,Toast.LENGTH_SHORT).show();
        Intent intent1 = new Intent(getApplicationContext(),InformacaoActivity.class);
        startActivity(intent1);
    }}

    private void listaMedicos(){
        String url  = HOST + "/readNutri.php";
