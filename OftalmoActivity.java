...
public class OftalmoActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oftalmo);

        edtnome = (EditText) findViewById(R.id.edtnome);
        listviewMedicos = (ListView) findViewById(R.id.listviewMedicos);

        lista = new ArrayList<Medico>();
        medicosAdapter = new MedicosAdapter(OftalmoActivity.this, lista);
    ...
    public void seleciona(View view) {
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(OftalmoActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
        Toast.makeText(OftalmoActivity.this,"Medico Selecionado" ,Toast.LENGTH_SHORT).show();
        Intent intent1 = new Intent(getApplicationContext(),InformacaoActivity.class);
        startActivity(intent1);
    }}

    private void listaMedicos(){
        String url  = HOST + "/readOfitalmo.php";
