...
public class NeuroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(NeuroActivity.this, lista);
    ...
    public void seleciona(View view) {if (edtnome.getText().toString().isEmpty()){
        Toast.makeText(NeuroActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();
