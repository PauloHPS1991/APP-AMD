...
public class PsicologaActivity extends AppCompatActivity {
    EditText edtnome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicosAdapter = new MedicosAdapter(PsicologaActivity.this, lista);
    ...
    public void seleciona(View view) {
        ...
        if (edtnome.getText().toString().isEmpty()){
            Toast.makeText(PsicologaActivity.this, "Precisa selecionar um medico",Toast.LENGTH_SHORT).show();

        }else {
            Toast.makeText(PsicologaActivity.this, "Medico Selecionado", Toast.LENGTH_SHORT).show();
    ...
    private void listaMedicos(){
        String url  = HOST + "/readPsicologo.php";
